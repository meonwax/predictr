...
EN: dict[str, str] = {
    ...
    "footer.copyright": "© by Sebastian Wolf",
...
DE: dict[str, str] = {
    ...
    "home.questions.deadline": "Stichtag {when}",
    ...
    "home.shouts.see_all": "Zur Shoutbox",
